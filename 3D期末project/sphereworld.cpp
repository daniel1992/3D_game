...
const char *szTextureFiles[] = {"grass.tga", "wood.tga", "VDV/vdv_Color.tga"};
...
void SetupRC()
{
    ...
    MODEL_SCENE = glmReadOBJ("old fashion town/old town block.obj");
...
//畫人
    ...
    glmDraw(MODEL, GLM_SMOOTH | GLM_TEXTURE);//GLM_FLAT
    //glMaterialfv(GL_FRONT, GL_SPECULAR, fNoLight);
...
//畫場景
    ...
    glmDraw(MODEL_SCENE, GLM_SMOOTH | GLM_TEXTURE);//GLM_FLAT
